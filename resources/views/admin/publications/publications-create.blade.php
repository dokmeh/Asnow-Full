    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Create Publication For {{ $project->title }}</h3>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br/>
                        <form id="demo-form2" action="/admin/project/{{ $project->id }}/publications" method="POST"
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">نام مجله:
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
